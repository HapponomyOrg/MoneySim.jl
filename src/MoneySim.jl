...
export curent_available, current_saved, current_money_stock, money_stock, debt_ratio, growth_ratio, profit_ratio, loan_ratio, delta_growth_profitexport, print_last_ratio
